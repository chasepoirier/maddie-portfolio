    ...
    return (
      <div className="resume main-content">
            ...
            <div className="main-container">
                ...
                <div className="right">
                <a className="button" target="blank" href="#">Download Resume</a>
            ...
            <div className="container">
                <div className="work">
                    <a className="company" target="blank" href="#">Flickr / YAHOO</a>
                ...
                <div className="work">
                    <a className="company" target="blank" href="#">ReadMe</a>
                ...
                <div className="work">
                    <a className="company" target="blank" href="#">Ripple</a>
                ...
                <div className="work">
                    <a className="company" target="blank" href="#">Udio Ventures</a>
